...
// TODO: These tests are skipped because vi.stubGlobal('import.meta', ...) does not work
// with Vite's import.meta.env at module evaluation time. Rewrite using vi.mock or
// environment-based approach to re-enable.
describe.skip('env', () => {
  beforeEach(() => {
    vi.clearAllMocks();
