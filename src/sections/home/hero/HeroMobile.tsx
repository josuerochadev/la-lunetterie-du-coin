...
function HeroMobileAccents({
  ...
  return (
    <div className="mx-auto mt-4 flex items-start gap-6 px-4 sm:mt-6 desk:hidden">
...
export function HeroMobileContent({ titleId }: { titleId?: string }) {
  ...
  return (
    <>
      ...
      <m.div
        className="absolute inset-0 z-0 overflow-hidden will-change-[clip-path] desk:hidden"
      ...
      <div className="absolute inset-x-0 bottom-[calc(16vw+0.5rem)] top-0 z-10 -mt-[0.1em] flex flex-col sm:bottom-[calc(24vw+1rem)] desk:hidden">
