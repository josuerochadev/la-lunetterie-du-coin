...
function FeaturedQuote({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    <m.div
      className="absolute inset-0 z-10 flex items-start px-container-x pt-[clamp(9rem,37vh,18rem)] md:pt-[clamp(22rem,34vh,28rem)]"
  ...
  return (
    <div ref={ref} style={{ height: `${SCROLL_HEIGHT_VH}vh` }}>
      <div className="sticky top-0 h-screen overflow-hidden">
        ...
        {/* Testimonial parade */}
        <div className="absolute inset-0 z-10 flex items-start px-container-x pt-[clamp(9rem,37vh,18rem)] md:pt-[clamp(22rem,34vh,28rem)]">
