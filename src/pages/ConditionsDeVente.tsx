    ...
    >
      ...
      <SimpleAnimation type="fade">
        <section className="space-y-6" aria-labelledby="retour">
          ...
          <div className="space-y-3 text-body text-black/70">
            <p>
      ...
      <SimpleAnimation type="fade">
        <section className="space-y-6" aria-labelledby="verres">
          ...
          <p className="text-center text-body-sm text-black/40">Délai : 30 jours après livraison</p>
        </section>
      </SimpleAnimation>
            ...
            <div>
              ...
              <dl className="space-y-2 border-l-4 border-black/10 pl-6 text-body">
                <div>
                  ...
                  <dd className="inline text-black/70">une monture par transaction</dd>
                </div>
                <div>
            ...
            <div>
              ...
              <dl className="space-y-2 border-l-4 border-black/10 pl-6 text-body">
                <div>
                  ...
                  <dd className="inline text-black/70">valable sur la monture la moins coûteuse</dd>
                </div>
                <div>
                  <dt className="inline font-medium text-text">Condition : </dt>
                  <dd className="inline text-black/70">pour l'achat d'un équipement de classe B</dd>
                </div>
                <div>
                  <dt className="inline font-medium text-text">Cumul : </dt>
                  <dd className="inline text-black/70">cumulable avec la remise à la reprise</dd>
                </div>
                <div>
                ...
                <div>
                  ...
                  <dd className="inline text-black/70">polarisation solaires ou double CozyLens</dd>
                </div>
              </dl>
            </div>
          </div>
