...
describe('Picture', () => {
  ...
  it('should use custom fallback src when provided', () => {
    render(<Picture {...defaultProps} fallbackSrc="/images/custom-fallback.jpg" />);
  ...
  it('should disable sources when disableSources is true', () => {
    const { container } = render(<Picture {...defaultProps} disableSources={true} />);
  ...
  it('should apply custom sizes attribute', () => {
    ...
    const { container } = render(<Picture {...defaultProps} sizes={customSizes} />);
